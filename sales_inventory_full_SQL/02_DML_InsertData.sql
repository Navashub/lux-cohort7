-- =====================================================
-- SALES & INVENTORY DATABASE - DML SCRIPT
-- Data Manipulation Language: INSERT DATA
-- =====================================================

-- =====================================================
-- INSERT DATA INTO CUSTOMERS TABLE (50 records)
-- =====================================================
...
-- =====================================================
-- INSERT DATA INTO PRODUCTS TABLE (15 records)
-- =====================================================
...
-- =====================================================
-- INSERT DATA INTO SALES TABLE (15 records)
-- =====================================================
...
-- =====================================================
-- INSERT DATA INTO INVENTORY TABLE (15 records)
-- =====================================================
...
-- Q1: Select all data from the Customers table
...
SELECT AVG(price) AS average_price FROM assignment.products;
...
-- Q7: Concatenate first and last names as full_name
SELECT 
    customer_id, 
...
-- Q8: All products in Electronics category
SELECT * FROM assignment.products WHERE category = 'Electronics';

-- Q9: Highest price from Products
SELECT MAX(price) AS highest_price FROM assignment.products;

-- Q10: Count the number of sales for each product
SELECT product_id, COUNT(*) AS sale_count FROM assignment.sales GROUP BY product_id;
...
-- Q12: Lowest price from Products
